  ...
  <div id="checkout">
    <div v-if="!isThankYouPage" class="checkout">
      <div class="checkout__main">
        ...
        >
          <SfStep v-for="step in steps" :key="step.key" :name="step.name">
            ...
            <div
              class="donmo-wrapper mobile-only"
              v-if="step.key === 'orderReview'"
            >
              <DonmoRoundup
                public-key="pk_test_7256412bdb58331a27f712a45c4798cd9ec5bd247c3d923af3fefeae2754f79d"
              />
            </div>
          </SfStep>
        </SfSteps>
      ...
      <div class="checkout__aside desktop-only">
        ...
        <div class="donmo-wrapper desktop-only">
          <DonmoRoundup
            public-key="pk_test_7256412bdb58331a27f712a45c4798cd9ec5bd247c3d923af3fefeae2754f79d"
          />
        </div>
